...
func main() {
	...
	// 		if n == t {
	// 			result := v * t
	// 			fmt.Printf("RESULT: %i V: %i T: %i", result, t, v)
	// 			return
	// 		}
	// 	}
	// }
	...
	tripleSet(entries, i1, i2, i3)
}


func tripleSet(t []int, p1, p2, p3 int) {
	a := t[p1]
	b := t[p2]
	c := t[p3]
	...
	if (a + b + c == 2020) {
		...
		tripleSet(t, p1, p2, p3)
	} else if (a + b + c > 2020) {
		fmt.Printf("TOO HIGH: %v", (a + b + c))
		if p3 > 0 {
			p3 = p3 - 1
		} else if  p1 > p3 + 1 {
			p1 = p1 - 1
